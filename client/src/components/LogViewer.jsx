...
// We tag a line based on which token appears in it. The check order matters
// because journalctl lines often contain both timestamps and the literal
// word "info" in a URL — so we anchor on the cloudflared markers first.
